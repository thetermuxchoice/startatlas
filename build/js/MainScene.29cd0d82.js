      ...
      class _ {
        ...
        sortPointsData() {
          this.sortPoints.forEach((t) => {
            !(function (t, e) {
              T.multiplyMatrices(e.projectionMatrix, e.matrixWorldInverse),
                T.multiply(t.matrixWorld);
              const i = t.geometry;
              let o = i.getIndex();
              ...
              S = [];
              for (let t = 0; t < n; t++)
                b.fromArray(a, 3 * t), b.applyMatrix4(T), S.push([b.z, t]);
              S.sort(L);
              const r = o.array;
          ...
          if (
            ...
            (this.init = (t) => {
              (this.container = t),
                ...
                (this.loadManager = new B(this.loadDone)),
              ...
              window.addEventListener("resize", () => this.onWindowResize()),
                ...
                (this.exploreNav = new H(this.gotoChapter)),
                this.setupChapters(),
